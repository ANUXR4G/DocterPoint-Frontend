...
export function InboxDownloadIcon({ className, pathClassName }: Props) {
  return (
    <svg
...
export function SpinningLoader({ className, pathClassName }: Props) {
  return (
    <svg
      className={className}
      version="1.1"
...
export function EnergyIcon({ className, pathClassName }: Props) {
  return (
    <svg
      viewBox="0 0 101 100"
      fill="none"
    ...
    >
      <path
        className={pathClassName}
        d="M47.9215 25.0109L33.4922 49.7503H43.7999L35.5542 66.2405L60.29 41.501H47.9215L58.2268 25.0109H47.9215Z"
      />
      <path
        className={pathClassName}
        d="M93.7854 45.1078C92.6447 34.8362 86.0643 30.7918 81.9837 29.2543C80.0531 24.9964 77.3809 21.1461 74.1167 17.8819L80.0507 11.9478C71.9871 5.49889 64.477 7.28115 60.5025 9.07788C56.2663 7.47288 51.6828 6.58658 46.892 6.58658V-1.78571C36.6192 -0.643757 32.576 5.93541 31.0385 10.016C26.7818 11.9466 22.9303 14.6188 19.6673 17.8831L13.7332 11.949C7.2831 20.0126 9.06657 27.5227 10.8633 31.4972C9.2583 35.731 8.37199 40.3169 8.37199 45.1078H-0.00390625C1.13804 55.3793 7.71721 59.4237 11.7978 60.9612C13.7284 65.2179 16.4006 69.0682 19.6649 72.3336L13.732 78.2677C21.7956 84.7166 29.3057 82.9331 33.2802 81.1376C37.5152 82.7426 42.0999 83.6277 46.8908 83.6277V92C57.1623 90.8593 61.2067 84.2789 62.743 80.1983C67.0009 78.2677 70.8512 75.5967 74.1154 72.3312L80.0495 78.2653C86.5008 70.2017 84.7161 62.6916 82.9206 58.7171C84.5244 54.4833 85.4107 49.8974 85.4107 45.1065H93.7854V45.1078ZM46.8908 76.928C29.3443 76.9292 15.0693 62.6542 15.0693 45.1078C15.0693 27.5613 29.3455 13.2875 46.8908 13.2875V13.2863C64.4372 13.2863 78.7122 27.5613 78.7122 45.1078C78.7122 62.6542 64.4372 76.928 46.8908 76.928Z"
      />
    </svg>
  )
}

export function KeyIcon({ className, pathClassName }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Monitoring({ className, pathClassName }: Props) {
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_1209_6654)">
        <path
          className={pathClassName}
...
export function GoogleIcon({ className, pathClassName }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
export function EnvelopeIcon({ className, pathClassName }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function ArrowUpDown({ className, pathClassName }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ImageUploadIcon({ className, pathClassName }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const MailUploadIcon = ({ className, pathClassName }: Props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={24}
...
export const NavigationIcon = ({ className, pathClassName }: Props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={24}
...
export function DownChevron({ className, pathClassName }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
