...
export default function Header({
  ...
  return (
    <motion.div
      ...
      className={`sticky top-0 z-30 flex w-full min-w-0 items-center px-3 pt-2 xs:px-4 ${
        embedded ? "" : "ml-auto md:w-[calc(100%-72px)] xl:w-[calc(100%-240px)]"
      }`}
    >
      <div className="flex h-14 w-full min-w-0 items-center justify-between gap-3 rounded-full border border-slate-200/80 bg-white/85 px-2 shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-800/90 dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] sm:px-3">
        <div
